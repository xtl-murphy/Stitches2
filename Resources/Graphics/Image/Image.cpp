...
////                else
////                {
////                    LOGE("", "cocos2d: unsupported image format!");
////                }
////
////                free(tgaData);
//                break;
...
return ret;
#else
    LOGE("", "jpeg is not enabled, please enable it in ccConfig.h");
    return false;
#endif // CC_USE_JPEG
}
...
return ret;
#else
    LOGE("", "png is not enabled, please enable it in ccConfig.h");
    return false;
#endif //CC_USE_PNG
}
...
//            {
//                _pixelFormat = PixelFormat::RGB5A1;
//            }
...
//            {
//                case CC_GL_ATC_RGB_AMD:
//                    _pixelFormat = PixelFormat::ATC_RGB;
//                    break;
//                case CC_GL_ATC_RGBA_EXPLICIT_ALPHA_AMD:
//                    _pixelFormat = PixelFormat::ATC_EXPLICIT_ALPHA;
//                    break;
//                case CC_GL_ATC_RGBA_INTERPOLATED_ALPHA_AMD:
//                    _pixelFormat = PixelFormat::ATC_INTERPOLATED_ALPHA;
//                    break;
//                default:
//                    break;
//            }
...
do
{
    ...
    _pixelFormat = config.input.has_alpha?PixelFormat::RGBA8888:PixelFormat::RGB888;
...
return ret;
#else
    LOGE("", "webp is not enabled, please enable it in ccConfig.h");
    return false;
#endif // CC_USE_WEBP
}
...
if (isCompressed() || (_pixelFormat != PixelFormat::RGB888 && _pixelFormat != PixelFormat::RGBA8888))
{
    CCLOG("cocos2d: Image: saveToFile is only support for PixelFormat::RGB888 or PixelFormat::RGBA8888 uncompressed data for now");
    return false;
}
...
void Image::premultiplyAlpha()
{
    ...
    return;
#else
    CCASSERT(_pixelFormat == PixelFormat::RGBA8888, "The pixel format should be RGBA8888!");
