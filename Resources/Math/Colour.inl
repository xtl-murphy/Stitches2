...
namespace std {
template<>
struct hash<Stitches::Colour> {
	size_t operator()(const Stitches::Colour &colour) const noexcept {
		size_t seed = 0;
        Stitches::Maths::HashCombine(seed, colour.r);
        Stitches::Maths::HashCombine(seed, colour.g);
        Stitches::Maths::HashCombine(seed, colour.b);
        Stitches::Maths::HashCombine(seed, colour.a);
		return seed;
	}
};
}
